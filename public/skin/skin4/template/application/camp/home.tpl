<span metal:define-macro="home" tal:omit-tag="" >
			...
			<td bgcolor="#ff9922" style="border:5px solid red;">
				<center>
					...
					<p style="font-size:14px; width:90%;">
						...
						<br />
						<br />
						<a href="index.php?app=option">[Zu den Einstellungen]</a>
						<br />
	...
	<table>
		 <tr>
			<td align="left">
				<div align="left">Zeitfenster ver&auml;nden = Das Lager kann nach hinten/vorne verk&uuml;rzt oder verl&auml;ngert werden. Das Lager kann nicht verk&uuml;rzt werden, falls dadurch Programmbl&ouml;cke verloren gehen. Alle Programmbl&ouml;cke bleiben an ihrem urspr&uuml;nglichen Datum.<br />
