<?php
	...
	if(is_array($css))
	{
		...
		{
			if($place == "app")
			{	$css_file = $public_app_dir . "/" . $_page->app . "/css/" . $css_file;	} elseif($place == "global")
			{	$css_file = $public_global_dir . "/css/" . $css_file;	} elseif($place == "module")
	...
	if(is_array($js))
	{
		...
		{
			if($place == "app")
			{$js_file = $public_app_dir . "/" . $_page->app . "/js/" . $js_file;} elseif($place == "global")
			{	$js_file = $public_global_dir . "/js/" . $js_file;	} elseif($place == "module")
