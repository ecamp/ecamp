...
var new_event = function( day_id )
{
	...
	popup_input_start_h.set( 'value', 12 );
	popup_input_length_h.set('value', 2 );
	...
	content = {
				...
				'popup_input_name': new Element('input').setStyles({'position': 'absolute', 'left': '270px', 'top': '30px', 'width': '200px', 'height': '15px', 'font-size': '11px'}).set('type', 'text'),
				...
				'popup_save_button': 	function()
					{
						...
						load_url = "index.php?app=day&cmd=save_add_event&" + args.toQueryString();
