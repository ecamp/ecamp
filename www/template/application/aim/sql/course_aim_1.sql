...
(NULL, LAST_INSERT_ID(), $camp_id, 'Die TN können das Stufenprofil der Ersten Stufe bewusst anwenden. ', NULL),
...
INSERT INTO course_aim VALUES
(NULL, NULL, $camp_id, 'Der Kurs bildet die TN aus, ein erststufengerechtes Programm zu planen, durchzuführen und auszuwerten.', NULL);
...
(NULL, LAST_INSERT_ID(), $camp_id, 'Die TN können ein Abenteuer planen, durchführen und auswerten.', NULL),
...
(NULL, LAST_INSERT_ID(), $camp_id, 'Die TN können ein Bienlivolk / eine Meute gut organisieren (bspw. Strukturieren der Einheit, sinnvolle Delegation von Aufgaben, Sicherstellen des Informationsflusses).', NULL),
(NULL, LAST_INSERT_ID(), $camp_id, 'Die TN kennen Möglichkeiten und Chancen der Teamführung.', NULL),
(NULL, LAST_INSERT_ID(), $camp_id, 'Die TN erhalten Anregungen zum Umgang mit schwierigen Kindern und Jugendlichen, kennen die Sicherheitsregeln und das Verhalten bei Notfällen. \n', NULL),
...
INSERT INTO course_aim VALUES 
(NULL, LAST_INSERT_ID(), $camp_id, 'Die TN setzen sich mit den Bedürfnissen der Kinder der Ersten Stufe auseinander und erkennen die unterschiedlichen Bedürfnisse von Mädchen und Knaben.', NULL),
(NULL, LAST_INSERT_ID(), $camp_id, 'Die TN kennen und vertiefen die Symbolik der Ersten Stufe.', NULL),
...
(NULL, LAST_INSERT_ID(), $camp_id, 'Die TN können die Grundlagen der Ersten Stufe ins Programm einbauen.', NULL),
(NULL, LAST_INSERT_ID(), $camp_id, 'Die TN können Lagerfeuer, stille Momente und ähnliche Aktivitäten mitgestalten.', NULL),
(NULL, LAST_INSERT_ID(), $camp_id, 'Die TN vertiefen die Grundkenntnisse der Pfaditechnik fur die Erste Stufe und können die Pfaditechnik stufengerecht anwenden.', NULL);
