<span metal:define-macro="info" tal:omit-tag="">
	...
	das Leben ein bisschen einfacher gemacht.
	<br /><br />
	Wir möchten uns dafür bedanken, dass eure Sommerlager mit eCamp geplant habt 
	und dass ihr auch immer wieder wertvolle Feedbacks hinterlassen habt. 
	<br /><br />
	Natürlich möchten wir uns die Gelegenheit nicht nehmen lassen um euch allen 
