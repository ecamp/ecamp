 ...
 */
	...
	// JS Umgebung laden
	$_js_env->add("template_aim1", file($GLOBALS['tpl_dir'] ."/application/aim/popup_new_aim1.tpl") );
	$_js_env->add("template_aim2", file($GLOBALS['tpl_dir'] ."/application/aim/popup_new_aim2.tpl") );
